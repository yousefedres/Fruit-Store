  ...
  return (
    <Container className="relative !my-10 !overflow-visible">
      ...
      <Box>
              ...
              <Card className="w-full py-8 px-4 max-h-auto md:max-h-30 !font-secondary relative text-[14px] !rounded-none !overflow-visible !shadow-none ">
                <CardActionArea className="!flex !flex-row !py-2 items-center justify-center gap-2 md:gap-14 !cursor-grab">
                  ...
                  <CardContent className="flex flex-col items-center justify-center">
                    ...
                    <Typography
                      variant="body2"
                      className=" !font-secondary !mb-3.5 w-[80%] md:w-auto "
                    >
                      {element.post}
                    </Typography>
                    <Typography
        ...
        <button
          className={`custom-prev absolute left-[0px] top-1/2 z-1000 cursor-pointer rounded-full text-secondary/50 hover:bg-gray-400/10 p-2 transition-opacity ${
        ...
        <button
          className={`custom-next absolute right-[0px] top-1/2 z-1000 cursor-pointer rounded-full text-secondary/50 hover:bg-gray-400/10 p-2 transition-opacity ${
